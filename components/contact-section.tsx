...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="pt-8 pb-20 sm:py-20 px-4 sm:px-6 lg:px-8 bg-muted/30 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            {contact.titleLead} <span className="text-primary">{contact.titleEmphasis}</span>
          </h2>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{contact.cards.email.title}</h3>
                    <p className="text-sm text-muted-foreground">{contact.cards.email.value}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{contact.cards.phone.title}</h3>
                    <p className="text-sm text-muted-foreground">{contact.cards.phone.value}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{contact.cards.hours.title}</h3>
                    <p className="text-sm text-muted-foreground" style={{ whiteSpace: "pre-line" }}>
                      {contact.cards.hours.value}
                    </p>
                  </div>
                </div>
              </CardContent>
